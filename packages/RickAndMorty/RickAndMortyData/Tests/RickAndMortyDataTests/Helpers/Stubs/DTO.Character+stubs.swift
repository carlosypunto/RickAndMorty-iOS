...
extension DTO.Character {
    static var charactersPageStub: DTO.Page<DTO.Character> {
        DTO.Page<DTO.Character>(
            info: DTO.Info(
                count: 826,
                pages: 42,
            ...
            results: charactersArrayStub
        )
    }

    static let charactersArrayStub: [DTO.Character] = [firstCharacterStub, secondCharacterStub]

    static let firstCharacterStub = DTO.Character(
        id: 1,
        name: "Rick Sanchez",
        status: .alive,
        species: "Human",
